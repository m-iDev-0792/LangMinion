...
LangMinion_prompt_lookup = "I will provide some English vocabulary. It may be a verb or a noun, or it may be both a verb and a noun, or something else entirely. If this word has a noun form, please tell me whether it is countable, what its singular and plural forms are, what their phonetic symbols and pronunciations are, how often it is used, and provide three example sentences. If this word has a verb form, please tell me what its first and third person, past tense, past participle, and passive tense are, what their phonetic symbols and pronunciations are, how often it is used, and also provide three example sentences. Just give your direct answers, don't say other things or ask me other questions."
